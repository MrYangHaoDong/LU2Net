...
class ULite(nn.Module):
    def __init__(self):
        ...
        self.e1 = EncoderBlock(16, 64)
        #self.e2 = EncoderBlock(32, 64)
        self.e3 = EncoderBlock(64, 256)
        ...
        self.d2 = DecoderBlock(64, 16)
        #self.d1 = DecoderBlock(32, 16)
        self.conv_out = nn.Conv2d(16, 3, kernel_size=1) #输出三维RGB图片  #self.conv_out = nn.Conv2d(16, 1, kernel_size=1)  
